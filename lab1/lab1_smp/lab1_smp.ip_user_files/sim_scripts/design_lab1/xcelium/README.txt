...
#
# Generated by export_simulation on Wed Oct 14 15:41:17 +0300 2020
#
################################################################################
...
'-reset_run' switch to the './design_lab1.sh' script.

./design_lab1.sh -reset_run
...
./design_lab1.sh -noclean_files

For more information on the script, please type './design_lab1.sh -help'.
