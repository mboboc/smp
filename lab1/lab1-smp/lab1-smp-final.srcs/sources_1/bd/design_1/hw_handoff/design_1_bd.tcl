...
proc create_root_design { parentCell } {
  ...
  set rst_0 [ create_bd_port -dir IO -type rst rst_0 ]
  set rst_1 [ create_bd_port -dir IO -type rst rst_1 ]
  ...
  connect_bd_net -net Net [get_bd_pins core_logic_0/c_be] [get_bd_pins graphic_controller_0/c_be]
  connect_bd_net -net Net1 [get_bd_pins core_logic_0/ad] [get_bd_pins graphic_controller_0/ad]
  connect_bd_net -net Net2 [get_bd_ports rst_0] [get_bd_pins graphic_controller_0/rst]
  connect_bd_net -net Net3 [get_bd_ports rst_1] [get_bd_pins core_logic_0/rst]
  connect_bd_net -net Net4 [get_bd_pins core_logic_0/ad_stb0] [get_bd_pins graphic_controller_0/ad_stb0]
  connect_bd_net -net Net5 [get_bd_pins core_logic_0/ad_stb1] [get_bd_pins graphic_controller_0/ad_stb1]
