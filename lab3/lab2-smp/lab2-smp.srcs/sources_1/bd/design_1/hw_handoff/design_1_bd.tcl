...
# module references:
# mpc106fsm, mx9_sdram, powerpcfsm, split1, split2
...
proc create_root_design { parentCell } {
  ...
  # Create instance: mx9_sdram_0, and set properties
  set block_name mx9_sdram
  set block_cell_name mx9_sdram_0
  if { [catch {set mx9_sdram_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $mx9_sdram_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: split1_0, and set properties
  set block_name split1
  set block_cell_name split1_0
  if { [catch {set split1_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $split1_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: split2_0, and set properties
  set block_name split2
  set block_cell_name split2_0
  if { [catch {set split2_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $split2_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_net -net CLK_0_1 [get_bd_ports CLK_0] [get_bd_pins mpc106fsm_0/CLK] [get_bd_pins mx9_sdram_0/CLK] [get_bd_pins powerpcfsm_0/CLK]
  ...
  connect_bd_net -net mpc106fsm_0_CS [get_bd_pins mpc106fsm_0/CS] [get_bd_pins split1_0/data]
  connect_bd_net -net mpc106fsm_0_DBG0 [get_bd_pins mpc106fsm_0/DBG0] [get_bd_pins powerpcfsm_0/DBG]
  connect_bd_net -net mpc106fsm_0_DH [get_bd_pins mpc106fsm_0/DH] [get_bd_pins split2_0/data]
  connect_bd_net -net mpc106fsm_0_SDCAS [get_bd_pins mpc106fsm_0/SDCAS] [get_bd_pins mx9_sdram_0/CAS]
  connect_bd_net -net mpc106fsm_0_SDMA [get_bd_pins mpc106fsm_0/SDMA] [get_bd_pins mx9_sdram_0/A]
  connect_bd_net -net mpc106fsm_0_SDRAS [get_bd_pins mpc106fsm_0/SDRAS] [get_bd_pins mx9_sdram_0/RAS]
  connect_bd_net -net mpc106fsm_0_TA [get_bd_pins mpc106fsm_0/TA] [get_bd_pins powerpcfsm_0/TA]
  connect_bd_net -net mpc106fsm_0_WE [get_bd_pins mpc106fsm_0/WE] [get_bd_pins mx9_sdram_0/WE]
  ...
  connect_bd_net -net split1_0_o7 [get_bd_pins mx9_sdram_0/CS] [get_bd_pins split1_0/o7]
  connect_bd_net -net split2_0_o07 [get_bd_pins mx9_sdram_0/DQ] [get_bd_pins split2_0/o07]
