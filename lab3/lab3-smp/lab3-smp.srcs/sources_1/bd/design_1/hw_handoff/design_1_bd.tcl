...
# module references:
# mpc106fsm, mx9_sdramfsm, powerpcfsm, splitter1, splitter2
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net [get_bd_pins mpc106fsm_0/DH] [get_bd_pins powerpcfsm_0/DH] [get_bd_pins splitter1_0/d_in]
  connect_bd_net -net Net1 [get_bd_pins mpc106fsm_0/TT] [get_bd_pins powerpcfsm_0/TT]
  ...
  connect_bd_net -net mpc106fsm_0_CS [get_bd_pins mpc106fsm_0/CS] [get_bd_pins splitter2_0/a]
  ...
  connect_bd_net -net splitter1_0_d_out [get_bd_pins mx9_sdramfsm_0/DQ] [get_bd_pins splitter1_0/d_out]
  connect_bd_net -net splitter2_0_b [get_bd_pins mx9_sdramfsm_0/CS] [get_bd_pins splitter2_0/b]
